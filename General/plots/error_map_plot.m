function COP = error_map_plot(NOMAP, errorMap, fpMeanCOP,fpVarCOP, stickMeanCOP, stickVarCOP,sphereFit,sphereFitVar)
...
if(NOMAP)
    ...
    f(2) = plot(NaN,NaN,'xk');
    f(3) = plot(NaN,NaN,'xg');
    legend(f,'Force plate COP (local coordinates)','Pole tip (rigid body transformation)','Pole tip (sphere fit)');
else
