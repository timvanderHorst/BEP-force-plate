function errorData = total_rmse_calc( filename, f, frames, startFrames, endFrames, stickTip, d, forceCOP, forceVector, R1final, V1final, Rfinal, Vfinal, CornerR, CornerV, Rtest, Vtest )
